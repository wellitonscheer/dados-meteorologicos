...
SYSTEM_INSTRUCTION = (
    ...
    "segunda planilha com os produtores e suas propriedades por duas tools — "
    "buscar_propriedades (filtra por um termo — inclusive por cultura — e "
    "devolve dados cadastrais, cultura e coordenadas geográficas exatas de cada "
    "propriedade) e ler_propriedades (lista o cadastro inteiro) —, à previsão "
    "do tempo por coordenada pela tool "
